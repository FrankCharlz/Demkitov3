...
public class CircleButton extends ImageView {
	...
	private static final int ANIMATION_TIME_ID3 = android.R.integer.config_shortAnimTime;
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			...
			color = a.getColor(R.styleable.CircleButton_cb_rangi, color);
			pressedRingWidth = (int) a.getDimension(R.styleable.CircleButton_cb_uneneWaKivuli, pressedRingWidth);
			a.recycle();
		}
